...
public class MainPage extends javax.swing.JFrame {
    ...
    public void initCards(){
        ...
        jPanel1.add(clients1, "clients1");
    }
    
    public void LogOut(){
      int reply = JOptionPane.showConfirmDialog(null, "You are leaving the system, are you sure you still want to continue?", "LogOut", JOptionPane.YES_NO_OPTION);
      if (reply == JOptionPane.YES_OPTION) { // Apparently, this returns 1 or 0 or true or false, hence stored in int data type 
        new Login();
    ...
    private void initComponents() {
        ...
        clients1 = new com.mycompany.benjcarrentalsystem.Clients();
        ...
        clientButton.setBackground(new java.awt.Color(255, 0, 0));
        clientButton.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 18)); // NOI18N
        ...
        SidePanel.add(clientButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 460, 260, 50));
        ...
        logOutButton.setBackground(new java.awt.Color(0, 0, 0, 25));
        logOutButton.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 12)); // NOI18N
        ...
        SidePanel.add(logOutButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 580, 290, 40));
    ...
    private void clientButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clientButtonActionPerformed
        // TODO add your handling code here:
        cardLayout.show(jPanel1,"clients1");
    ...
    private com.mycompany.benjcarrentalsystem.Clients clients1;
